...
class Config:
    ...
    RAM_CLEAN_THRESHOLD = float(os.environ.get('RAM_CLEAN_THRESHOLD', 20.0))
    DISK_CLEAN_THRESHOLD_PERCENT = float(os.environ.get('DISK_CLEAN_THRESHOLD_PERCENT', 90.0))
